      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="certificaciones"><i class="fa fa-circle-o"></i>certificaciones</a></li>
            ...
            <li><a href="mercancias"><i class="fa fa-circle-o"></i>Mercancias</a></li>
            <li class="active"><a href="servicios"><i class="fa fa-circle-o"></i> Servicios</a></li>
          </ul>
        </li>
        <li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Mercancía</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tr>
                  <td>01</td>
                  <td>
                      Mercancia de prueba 01
                  </td>
                </tr>
                <tr>
                  <td>01</td>
                  <td>
                      Mercancia de prueba 02
                  </td>
                </tr>
                <tr>
                  <td>03</td>
                  <td>
                      Mercancia de prueba 03
                  </td>
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabla con Características</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
